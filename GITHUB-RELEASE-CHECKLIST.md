...
## 目标
把当前已在 `<private-first-party-webchat>` 中验证有效的 CLAWeb 能力，整理回 `workspace/claweb`，形成一个**可公开理解、可公开安装、可公开示例化**的通用项目，再更新到 GitHub。
...
- 本地服务地址与运维细节
- first-party 私有关系设定
- 用户专属身份命名（如 `demo-user-b` / `demo-passphrase` 若带真实语境）
